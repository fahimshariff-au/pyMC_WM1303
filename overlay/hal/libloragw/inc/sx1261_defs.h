...
typedef enum {
    ...
    SX1261_SET_CAD                  = 0xC5,
    SX1261_SET_CAD_PARAMS           = 0x88
} sx1261_op_code_t;

/* IRQ bit masks */
#define SX1261_IRQ_CAD_DONE             0x0080  /* bit 7 */
#define SX1261_IRQ_CAD_DETECTED         0x0100  /* bit 8 */
#define SX1261_IRQ_ALL                  0x03FF  /* all IRQ bits */

/* CAD exit modes */
#define SX1261_CAD_EXIT_STDBY           0x00
#define SX1261_CAD_EXIT_RX              0x01
