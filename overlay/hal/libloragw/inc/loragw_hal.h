...
#define IS_LORA_BW(bw)          ((bw == BW_62K5HZ) || (bw == BW_125KHZ) || (bw == BW_250KHZ) || (bw == BW_500KHZ))
...
@brief Configuration structure for additional SX1261 radio used for LBT, Spectral Scan, and LoRa RX
*/
struct lgw_conf_sx1261_s {
